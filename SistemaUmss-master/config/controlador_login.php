...
$query = "SELECT u.id, u.correo , u.contrasena, u.nombre, r.nombre as rol FROM usuario u LEFT JOIN roles r ON u.id_rol = r.id_rol WHERE correo = '$correo' AND contrasena = '$contrasena'";
